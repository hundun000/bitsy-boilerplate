...
after('onready', function () {
	if (hackOptions.autosaveInterval < Infinity) {
		...
		autosaveInterval = setInterval(modified_save, hackOptions.autosaveInterval);
	}
});
...
addDualDialogTag('save', modified_save);
